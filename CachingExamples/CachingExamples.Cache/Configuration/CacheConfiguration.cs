using CachingExamples.Cache.Configuration.Collections;
using CachingExamples.Cache.Configuration.Elements;
using CachingExamples.Cache.Serialization;
using System.Configuration;

namespace CachingExamples.Cache.Configuration
{
    /// <summary>
    ...
    public class CacheConfiguration : ConfigurationSection
    {
        ...
        public static CacheConfiguration Current
        {
            get
            {
                var current = ConfigurationManager.GetSection("cachingexamples.cache") as CacheConfiguration;
                if (current == null)
                {
        ...
        /// <summary>
        /// Returns the configuration settings for cache targets
        /// </summary>
        ...
        /// </summary>
        [ConfigurationProperty(SettingName.DefaultCacheName, DefaultValue = "CachingExamples.Cache")]
